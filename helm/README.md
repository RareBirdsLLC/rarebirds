...
- [Deploy RareBirds components to your cluster](#deploy-rarebirds-components-to-your-cluster)
...
```bash
helm install . --name rarebirds --namespace my-namespace --set tags.minimal=true
```
...
| `global.image.tag`                 | `rarebirds` image tag                                                                                                        | `master`                               |
| `global.fqdn`                      | ingress host                                                                                                                 | `my-rarebirds-url.com`                 |
| `global.fqdn`                      | ingress host                                                                                                                 | `my-rarebirds-url.com`                 |
...
```bash
helm install . --name rarebirds --namespace my-namespace --set tags.minimal=true --set frontend-1.ingress.enabled=true
```
