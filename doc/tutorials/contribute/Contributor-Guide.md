...
This document describes how to set up your environment to start developing and debugging the RareBirds application. The first section describes the recommended tools for development, the second part is dedicated to the installation on your local machine for development and debugging.
...
The `/api/src` folder contains README files on each level which describe the layout and architecture of the API. You can start reading [here](https://github.com/realChainLife/RareBirds/blob/master/api/src/README.md)
...
There is a service that exports RareBirds data into an Excel sheet. The service is a node package and needs to be started separately. To start the service, follow these commands:
...
| Description           | Link                                                                                                              |
| :-------------------- | :---------------------------------------------------------------------------------------------------------------- |
| How to run e2e-tests? | https://github.com/realChainLife/RareBirds/blob/master/doc/wiki/Contributor-Guide/Contributor-Guide.md#end-to-end-tests |
| How to run unit-test? | https://github.com/realChainLife/RareBirds/blob/master/doc/wiki/Contributor-Guide/Contributor-Guide.md#unit-tests       |
-->
